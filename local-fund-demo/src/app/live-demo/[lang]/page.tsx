...
function buildConfig(lang: SupportedLang): LiveDemoConfig {
  ...
  return {
    ...
    hypotheses: [
      {
        id: 'ai-cert-tiering',
        title: 'Risk-tiered AI certification',
        hypothesis: 'The FAA should certify aviation AI/ML systems using risk-stratified tiers — light oversight for advisory tools, full DO-178 equivalent for safety-critical autonomy — rather than a single uniform process.',
        logs: [
          '[GraphRAG Build] Extracting AI use cases and certification entities from the FAA plan...',
          '[GraphRAG Build] Linking risk classes to oversight requirements (nodes: 142, edges: 351)',
          '[Env Setup] Generating FAA, NASA, airline, OEM, and union personas...',
          '[Simulation] Running multi-stakeholder review of tier proposals...',
          '[Result Generation] Aggregating votes on tier boundaries and oversight depth...',
          '[Report] Producing tiered certification recommendation with evidence...',
          '[System] Entering Deep Interaction mode',
        ],
        reportCards: [
          { title: 'Recommendation', value: 'Tiered cert', note: 'Risk-proportionate', accent: 'emerald' },
          { title: 'Stakeholder signal', value: 'Mixed', note: 'Pilots vs OEMs', accent: 'blue' },
          { title: 'Mode', value: 'Static', note: 'No external APIs', accent: 'amber' },
        ],
        qa: [
          {
            id: 'why-tiered',
            question: 'Why is risk-tiered certification preferred over a single process?',
            answer: 'In this static demo, the personas converge on tiering because uniform certification either over-burdens low-risk advisory AI (e.g., maintenance planning) or under-scrutinizes safety-critical autonomy. Tiers map oversight depth to consequence severity.',
            keywords: ['tier', 'risk', 'certification', 'why', 'certify'],
          },
          {
            id: 'high-risk-cert',
            question: 'Why is something classified as "high risk"?',
            answer: 'High risk is triggered when an AI/ML component has authority over flight-critical decisions, lacks deterministic fallback, or exposes passenger safety. Lower-risk uses (analytics, scheduling) get lighter oversight.',
            keywords: ['high risk', 'classify', 'critical', 'safety'],
          },
        ],
      },
      {
        id: 'industry-self-cert',
        title: 'Industry self-certification limits',
        hypothesis: 'Allowing OEMs and airlines to self-certify AI/ML components beyond a defined risk threshold creates accountability gaps that the FAA cannot retroactively close.',
        logs: [
          '[GraphRAG Build] Extracting self-certification clauses and FAA oversight authority...',
          '[GraphRAG Build] Mapping accountability paths between OEMs, FAA, and NTSB...',
          '[Env Setup] Generating OEM, airline IT, FAA inspector, and pilot union personas...',
          '[Simulation] Running incident-response scenarios with mixed certification regimes...',
          '[Report] Producing accountability gap analysis with evidence links...',
          '[System] Entering Deep Interaction mode',
        ],
        reportCards: [
          { title: 'Finding', value: 'Gap exists', note: 'Above threshold', accent: 'emerald' },
          { title: 'Driver', value: 'Audit authority', note: 'Post-incident', accent: 'blue' },
          { title: 'Mode', value: 'Static', note: 'No external APIs', accent: 'amber' },
        ],
        qa: [
          {
            id: 'accountability-gap',
            question: 'Where does the accountability gap appear?',
            answer: 'It appears when an AI component fails after the FAA has accepted an OEM self-certification: the FAA lacks the source-level audit authority of a fully certified system, and NTSB investigations stall on proprietary model behavior.',
            keywords: ['accountability', 'gap', 'fail', 'self-cert', 'audit'],
          },
          {
            id: 'who-certifies',
            question: 'Who actually certifies the model behavior?',
            answer: 'In this demo, the agreed line is: under threshold = OEM self-attestation with FAA audit rights; above threshold = full third-party verification before deployment.',
            keywords: ['who', 'certif', 'verify', 'oem', 'third'],
          },
        ],
      },
    ],
      evidenceTitle: 'Hypothesis & Evidence',
      evidenceBullets: [
        'Reading the FAA AI certification research plan into a grounded GraphRAG',
        'Generating regulator, operator, OEM, and pilot-union personas',
        'Running parallel multi-stakeholder simulation to test certification tiers',
      ],
      pipeline: [
    ...
    sourceSummary: {
      ...
      keyClaim: 'The FAA Office of NextGen lays out a research plan for certifying AI/ML applications introduced to the National Airspace System under Section 741 of the FAA Reauthorization Act of 2018.',
      cards: [
        { title: 'Focus', value: 'AI certification', note: 'NAS-bound AI/ML' },
        { title: 'Output', value: 'Tiered plan', note: 'Risk-proportionate oversight' },
      ],
      examplesTitle: 'Example extractions',
      examples: ['AI/ML use-case taxonomy', 'Certification value chain and outcomes', 'Gaps versus traditional software certification'],
    },
  };
}
