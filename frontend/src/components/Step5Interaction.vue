...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    // Convert object dictionary to array and get replies from reddit platform first
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Use the reddit platform first to reply, followed by twitter
...
/* Fix ordered list numbering - use CSS counters to make multiple ols numbered consecutively */
.message-text {
