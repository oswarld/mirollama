...
/**
 * Get real-time simulation configuration during build
 * @param {string} simulationId
...
/**
 * Get the real-time status of the simulation run
 * @param {string} simulationId
 */
 ...
 * Used to display historical items on the home page
 * @param {number} limit - Return quantity limit
 */
