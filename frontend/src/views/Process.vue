      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Once completed, graph build will start automatically.</p>
          </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After you upload documents, the LLM analyzes the content and generates an ontology structure for simulation (entity types + relation types).
                </div>
              </div>
...
const currentPhase = ref(-1) // -1: Uploading, 0: Ontology, 1: Graph build, 2: Complete
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No pending files found. Please go back to Home and try again.'
    loading.value = false
    return
  }
...
const startGraphPolling = () => {
  ...
  // Automatically acquire spectral data every 10 seconds
...
const renderGraph = () => {
  ...
  // Create a node ID set to filter valid edges
  ...
  simulation.on('tick', () => {
    // Update the position of all edges (including visible lines and transparent hit areas)
