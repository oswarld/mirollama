<template>
  <div class="home-container">
    <!-- top navigation bar -->
    <nav class="navbar">
      <div class="nav-brand">MIROLLAMA</div>
      <div class="nav-links">
        <LanguageSwitcher />
        <a href="https://github.com/oswarld/mirollama" target="_blank" class="github-link">
    ...
    <div class="main-content">
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <!-- Introduction to project simulation steps (Add new area) -->
...
// Computed properties:Is it possible to submit
...
// Handling drag and drop related
...
// Start simulation - jump immediately, API calls are made on the Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Jump immediately to the Process page (use a special identifier to indicate a new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk as main heading font and JetBrains Mono for code/label font
    Make sure you include these in index.html Google Fonts 
  */
