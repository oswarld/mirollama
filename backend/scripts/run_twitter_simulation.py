"""
OASIS TwitterSimulation preset script
This script reads the parameters in the configuration file to perform simulation and realize full automation.

Features:
- After completing the simulation, do not close the environment immediately and enter the waiting command mode.
...
class IPCHandler:
    ...
    async def handle_interview(self, command_id: str, agent_id: int, prompt: str) -> bool:
        ...
        try:
            ...
            error_msg = str(e)
            print(f"  Interviewfail: agent_id={agent_id}, error={error_msg}")
    ...
    async def handle_batch_interview(self, command_id: str, interviews: List[Dict]) -> bool:
        ...
        try:
            ...
            actions = {}
            agent_prompts = {}  # Record each agent’sprompt
            ...
            error_msg = str(e)
            print(f"  Batch interviews failed: {error_msg}")
            self.send_response(command_id, "failed", error=error_msg)
            return False
...
class TwitterSimulationRunner:
    ...
    async def run(self, max_rounds: int = None):
        ...
        for round_num in range(total_rounds):
            ...
            # Get activated in this roundAgent
