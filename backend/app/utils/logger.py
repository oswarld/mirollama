...
def setup_logger(name: str = 'mirollama', level: int = logging.DEBUG) -> logging.Logger:
    """
    Set up logger
    ...
    # 2. Console Handler - Concise Logging (INFO and above)
...
def get_logger(name: str = 'mirollama') -> logging.Logger:
    """
