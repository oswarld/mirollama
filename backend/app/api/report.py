...
logger = get_logger('mirollama.api.report')
...
def get_generate_status():
    ...
    Request (JSON):
        {
            "task_id": "task_xxxx",         // Optional, returned by generatetask_id
            "simulation_id": "sim_xxxx"     // Optional, simulateID
        }
...
def list_reports():
    ...
    Query parameters:
        simulation_id: Filter by impersonation ID (optional)
...
# ============== Report Agentconversational interface ==============
...
def get_agent_log(report_id: str):
    ...
    - Reporting begins, planning begins/Complete
    - The start, tool call, LLM response, and completion of each chapter
    - Report completion or failure
    
    Query parameters:
        from_line: Which row to start reading from (optional, default 0, used for incremental acquisition)
...
def search_graph_tool():
    ...
    try:
        ...
        from ..services.search_tools import SearchToolsService
        
        tools = SearchToolsService()
