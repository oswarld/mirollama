...
Interface 2: Built using Zep APIStandalone Graph
"""
...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        graph_name: str = "mirollama Graph",
        chunk_size: int = 500,
    ...
    def create_graph(self, name: str) -> str:
        ...
        graph_id = f"mirollama_{uuid.uuid4().hex[:16]}"
        
        self.client.graph.create(
            graph_id=graph_id,
            name=name,
            description="mirollama Social Simulation Graph"
        )
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # Suppressing Pydantic v2 About Field(default=None) warning
        ...
        # Zep Reserved name, cannot be used as attribute name
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            for attr_def in entity_def.get("attributes", []):
                ...
                # Zep API A description of the Field is required, this is required
