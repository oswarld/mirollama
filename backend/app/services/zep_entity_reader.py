...
logger = get_logger('mirollama.zep_entity_reader')
...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            func: The function to execute (lambda or callable without parameters)
    ...
    def filter_defined_entities(
        ...
        Filter logic:
        - If the node has only one Labels"Entity", indicating that this entity does not conform to our predefined type, skip
        - If the node's Labels contain anything other than"Entity"and"Node"Tags other than the description match the predefined type and are reserved
        ...
        """
        logger.info(f"Start filtering entities from graph {graph_id}...")
        ...
        for node in all_nodes:
            ...
            # Filter logic: Labels must contain"Entity"and"Node"tags outside
        ...
        logger.info(f"Filtering complete: total_nodes={total_count}, matched={len(filtered_entities)}, "
