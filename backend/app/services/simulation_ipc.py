...
Implement simple commands through the file system/Response mode:
1. Flask writes commands to commands/ Directory
2. The simulation script polls the command directory, executes the command and writes the response to responses/ Directory
...
logger = get_logger('mirollama.simulation_ipc')
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: During the dual-platform simulation, interview both platforms at the same time, and during the single-platform simulation, interview the platform.
            timeout: timeout
