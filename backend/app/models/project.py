...
Used to persist project status on the server side to avoid the front-end passing large amounts of data between interfaces
"""
...
class ProjectManager:
    """Project Manager - Responsible for the persistent storage and retrieval of projects"""
    ...
    def get_project(cls, project_id: str) -> Optional[Project]:
        ...
        Returns:
            ProjectObject, returned if it does not existNone
        """
    ...
    def list_projects(cls, limit: int = 50) -> List[Project]:
        ...
        Returns:
            List of projects, in descending order of creation time
        """
        cls._ensure_projects_dir()
    ...
    def save_file_to_project(cls, project_id: str, file_storage, original_filename: str) -> Dict[str, str]:
        ...
        Args:
            project_id: projectID
            file_storage: FlaskFileStorage object
